...
Run 8Router on your local machine for development and personal use.

---

## 📦 Installation

Install 8Router globally via npm:
...
Start 8Router with a single command:
...
Press `Ctrl+C` in the terminal where 8Router is running.
