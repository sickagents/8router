...
Integra 8Router con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de 8Router desde el [dashboard](https://8router.com/dashboard)
- 8Router ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de 8Router
...
```json
{
  "models": [
    {
      "title": "8Router - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20127/v1"
    ...
    {
      "title": "8Router - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "8Router - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "8Router - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de 8Router
...
- Verifica que 8Router esté corriendo: `curl http://localhost:20127/health`
...
- Selecciona el modelo correcto de 8Router
...
- Verifica la latencia de red hacia 8Router
