...
8Router is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

8Router provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to 8Router using these settings:

**Local 8Router:**
```
Base URL: http://localhost:20127/v1
API Key: your-api-key-from-dashboard
Model: any 8Router model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to 8Router
```bash
...
- Check network connection to 8Router
