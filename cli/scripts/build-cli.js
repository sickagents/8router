...
console.log("📦 Building 8Router CLI package with Next.js...\n");
...
// Strip better-sqlite3 (native) — it lives in ~/.8router/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.8router/runtime)");
}
console.log("");
