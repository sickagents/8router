...
Detailed installation guide for 8Router with troubleshooting tips.
...
Install 8Router globally to use from anywhere:
...
- ✅ Simple command: `8router`
- ✅ Auto-updates with `npm update -g 8router`
...
3. Data directory created at `~/.8router`
...
**Issue:** 8Router using too much RAM
