...
Tích hợp 8Router với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của 8Router.
...
8Router cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong 8Router dashboard
...
1. Xác minh tên model khớp với cấu hình 8Router
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong 8Router dashboard
...
Đảm bảo bạn đã cấu hình API key trong 8Router cloud dashboard.
