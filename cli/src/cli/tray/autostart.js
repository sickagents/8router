...
const APP_LABEL = "com.8router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when 8router is currently
 ...
 * SIGTERM to the running process. When the running 8router cli.js was itself
...
<dict>
    ...
    <string>/tmp/8router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/8router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `8router.cmd` lookup that depended on the npm prefix path.
