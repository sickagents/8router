...
Những câu hỏi phổ biến về 8Router.

---

## 8Router là gì?

**8Router là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**8Router dùng chiến lược pricing 3 tầng:**
...
## 8Router có miễn phí không?

**Có, 8Router hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của 8Router.**
...
**8Router theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host 8Router không?

**Có! 8Router hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.8router`)
...
**Có, 8Router ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.8router` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server 8Router
...
## Làm thế nào để cập nhật 8Router?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/8router/blob/main/CHANGELOG.md)
- Backup `~/.8router` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/8router/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [8router.com/docs](https://8router.com/docs)
