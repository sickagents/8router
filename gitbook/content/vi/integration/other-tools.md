...
8Router tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

8Router cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến 8Router bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến 8Router
```bash
...
- Kiểm tra kết nối network đến 8Router
