...
Integrate 8Router with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- 8Router API key from [dashboard](https://8router.com/dashboard)
- 8Router running (local or cloud)
...
### 2. Add 8Router Model Configuration
...
3. Choose your preferred 8Router model
...
- Check network latency to 8Router
