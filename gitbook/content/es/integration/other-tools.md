...
8Router es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

8Router proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a 8Router usando estas configuraciones:

**8Router local:**
```
Base URL: http://localhost:20127/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de 8Router (cc/*, cx/*, glm/*, etc.)
```

**8Router en la nube:**
```
Base URL: https://8router.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de 8Router (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a 8Router
```bash
# Verifica si 8Router está corriendo
...
**Solución:**
- Verifica que 8Router esté corriendo
...
- Verifica la conexión de red a 8Router
