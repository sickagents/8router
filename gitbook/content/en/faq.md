...
Common questions about 8Router.

---

## What is 8Router?

**8Router is an AI model router that maximizes your subscription value and minimizes costs.**
...
**8Router uses a 3-tier pricing strategy:**
...
**Yes, 8Router itself is 100% free and open source.**
...
**Yes! This is 8Router's core feature.**
...
**8Router tracks quota in real-time for all providers:**
...
## Can I self-host 8Router?

**Yes! 8Router supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.8router`)
...
**Yes, 8Router prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.8router` (or custom `DATA_DIR`)
- No data sent to 8Router servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/8router/blob/main/CHANGELOG.md)
- Backup `~/.8router` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/8router/blob/main/CONTRIBUTING.md) for details.
