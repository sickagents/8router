 ...
 * API. They are 8router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic 8router variant set for a single upstream Kiro model.
 *
 ...
 * into 8router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
