...
Deploy 8Router on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.8router` | Database and data storage path |
...
Create `/etc/nginx/sites-available/8router`:
