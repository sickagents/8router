 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what 8router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a 8router
...
/**
 * Detect whether a model id refers to a 8router synthetic agentic variant.
...
/**
 * Detect whether a model id is a 8router synthetic thinking variant
...
/**
 * Resolve a 8router model id to the real upstream Kiro model id, plus flags
