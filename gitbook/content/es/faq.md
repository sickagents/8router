...
Preguntas comunes sobre 8Router.

---

## ¿Qué es 8Router?

**8Router es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**8Router usa una estrategia de precios de 3 niveles:**
...
**Sí, 8Router en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de 8Router.**
...
**8Router rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿8Router funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de 8Router:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://8router.com/v1
...
## ¿Puedo auto-hospedar 8Router?

**¡Sí! 8Router soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.8router`)
...
**Sí, 8Router prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.8router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de 8Router
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/8router/blob/main/CHANGELOG.md)
- Respalda `~/.8router` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/8router/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/8router/discussions)
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/8router/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [8router.com/docs](https://8router.com/docs)
