...
// Build TOML config for 8Router (openai provider mode)
const build8RouterConfig = (baseUrl, apiKey, model) => {
...
// Detect 8Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = build8RouterConfig(baseUrl, apiKey || "sk_8router", model);
