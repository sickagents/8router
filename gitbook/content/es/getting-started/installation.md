...
Guía detallada de instalación de 8Router con consejos de solución de problemas.
...
Instala 8Router globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `8router`
- ✅ Auto-actualizaciones con `npm update -g 8router`
...
3. Se crea el directorio de datos en `~/.8router`
...
**Problema:** 8Router usa demasiada RAM
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con 8router
```
...
- **Sitio web**: [8router.com](https://8router.com)
