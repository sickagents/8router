...
Pon en marcha 8Router en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a 8Router:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de 8router]
