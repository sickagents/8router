...
Integra 8Router con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de 8Router.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- 8Router ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de 8Router:
...
**Para 8Router en la nube:**
```
https://8router.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de 8Router
...
4. Cline usará 8Router para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando 8Router
...
3. Obtén explicaciones potenciadas por IA a través de 8Router

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará 8Router para entender el contexto y hacer cambios
...
1. Verifica que 8Router esté corriendo: `curl http://localhost:20127/health`
...
2. Verifica que tu instancia de 8Router esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de 8Router para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de 8Router en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://8router.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de 8Router
...
## Integración con características de 8Router

### Enrutamiento de modelos

8Router enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, 8Router automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de 8Router:
