...
Triển khai 8Router trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.8router` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/8router`:
...
# If NOT using reverse proxy, allow 8Router ports
