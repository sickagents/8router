...
Problemas comunes y soluciones al usar 8Router.
...
1. **Refresh automático (por defecto):**
   8Router refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si 8Router está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep 8router
...
- **GitHub Issues:** [github.com/decolua/8router/issues](https://github.com/decolua/8router/issues)
