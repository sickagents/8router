...
Tích hợp 8Router với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model 8Router có sẵn:
...
### Connection Failed
- Xác minh 8Router đang chạy: `curl http://localhost:20127/health`
