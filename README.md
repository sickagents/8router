...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>8Router + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với 8Router<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with 8Router 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + 8Router<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
...
> 🎬 **Made a video about 8Router?** Submit a [Pull Request](https://github.com/decolua/8router/pulls) adding your video to this section — we'll merge it!
...
- Docker Hub: [`decolua/8router`](https://hub.docker.com/r/decolua/8router)
- GHCR: [`ghcr.io/decolua/8router`](https://github.com/decolua/8router/pkgs/container/8router)
...
docker run -d --name 8router -p 20127:20127 \
  -v "$HOME/.8router:/app/data" -e DATA_DIR=/app/data 8router
```
...
docker pull decolua/8router:latest   # update to latest
```

**Data persistence:** `$HOME/.8router/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable | Default | Description |
|----------|---------|-------------|
| `JWT_SECRET` | Auto-generated (`~/.8router/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances) |
| `INITIAL_PASSWORD` | `123456` | First login password when no saved hash exists |
| `DATA_DIR` | `~/.8router` | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`) |
...
- Both `${DATA_DIR}` and `~/.8router` resolve to the same location in a Docker container — the symlink `/root/.8router -> /app/data` is created at build time.
...
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral *"why use many token when few token do trick"*. 8Router adapts its prompt → **−65% output tokens**.

Huge thanks to these authors — without their work, 8Router's token-saving features wouldn't exist. ⭐ them on GitHub!
