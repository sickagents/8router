...
Tích hợp 8Router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- 8Router API key từ [dashboard](https://8router.com/dashboard)
- 8Router đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra 8Router đang chạy: `curl http://localhost:20127/health`
...
- Kiểm tra độ trễ network đến 8Router
