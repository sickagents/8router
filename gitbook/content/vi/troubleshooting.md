...
Các vấn đề và giải pháp phổ biến khi dùng 8Router.
...
1. **Auto-refresh (mặc định):**
   8Router tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra 8Router có chạy không:**
   ```bash
   # Check process
   ps aux | grep 8router
