...
8RouterをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://8router.com/dashboard)からの8Router APIキー
- 8Routerが動作中 (ローカルまたはクラウド)
...
### モデルが応答しない
- 8Routerが動作中か確認: `curl http://localhost:20127/health`
