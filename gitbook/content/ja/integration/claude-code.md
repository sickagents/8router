...
8RouterをClaude Code CLIと統合し、AnthropicのAPIリクエストを8Routerのインテリジェントルーティングシステム経由でルーティングします。
...
Claude Codeは8Routerモデルにマッピングされる以下のモデルエイリアスをサポート:
