...
Tích hợp 8Router với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của 8Router.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model 8Router:
